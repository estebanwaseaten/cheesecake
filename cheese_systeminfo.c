...
int extractSCScomponent( debugComponent *thisComponent )
{
    ...
    comArray localComArray;
    comArrayInit( &localComArray );
    int nextIndex = comArray_prepMemAccess( &localComArray, 0x00, thisComponent->baseAddr + 0xDF0 );    //
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0xA05F0003 );       //HALT PROCESSOR

    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xDF0 ); //same addr again
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0xA05F0004 );       //set C_STEP = 1

    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xDFC );
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0x1 );

    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xD0C );  //AIRCR
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0xfa050004 );

    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xDF8 );  //
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0x20000119 );
    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xDF4 );  //
    ...
    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xD08 );  //
    ...
    nextIndex = comArray_prepMemAccess( &localComArray, 0x00, thisComponent->baseAddr + 0xDF0 );    //
    comArrayAdd( &localComArray, AP_WRITE3_CMD, 0xa05f0000 );       //UNHALT PROCESSOR
    comArrayAdd( &localComArray, AP_WRITE1_CMD, thisComponent->baseAddr + 0xDF0 );  //
    comArrayAdd( &localComArray, AP_READ3_CMD, 0x0 );
    comArrayAdd( &localComArray, AP_READ3_CMD, 0x0 );
    reply = comArrayTransfer( &localComArray );
    if( reply < 0 )
